...
* BPM-265 https://youtrack.haulmont.com/issue/BPM-265[Error on migrating the process instance] 
...
* BPM-286 https://youtrack.haulmont.com/issue/BPM-286[Duplicate rule IDs in DMN table editor] 
...
* BPM-279 https://youtrack.haulmont.com/issue/BPM-279[Input dialog parameters with Platform enum type are saved as String]
