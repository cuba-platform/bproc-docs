...
```
classpath*:resources/bpmn/**/*.bpmn20.xml
```

This means that all files with names ending with `.bpmn20.xml` and located under the `resources\bpmn` package of the _core_ module will be deployed when the application is started.
...
```
classpath*:resources/dmn/**/*.dmn.xml
```

This means that all files with names ending with `.dmn.xml` and located under the `resources\dmn` package of the _core_ module will be deployed when the application is started.
